...
namespace AuthSharp.Native
{
    ...
    {
        private const string NCURSES_LIB = "libncursesw.so.5";
        ...
        /// <summary>
        /// Create a new window and return a pointer to the WINDOW struct
        /// </summary>
        ...
        /// <returns></returns>
        [DllImport(NCURSES_LIB)]
        internal static extern IntPtr newwin(int height, int width, int starty, int startx);

        /// <summary>
        /// Delete the window. This needs to be called for every window created using newwin
        /// </summary>
        /// <param name="window"></param>
        [DllImport(NCURSES_LIB)]
        internal static extern void delwin(IntPtr window);
        ...
        /// <summary>
        /// Exits the cbreak mode (no lines buffering in input).
        /// </summary>
        [DllImport(NCURSES_LIB)]
        internal static extern int nocbreak();

        /// <summary>
        /// Should be called to enable echo.
        /// </summary>
        [DllImport(NCURSES_LIB)]
        internal static extern int echo();
        ...
        [DllImport(NCURSES_LIB)]
        internal static extern void wrefresh(IntPtr window);

        [DllImport(NCURSES_LIB)]
        internal static extern void clear();

		[DllImport(NCURSES_LIB)]
        internal static extern void wclear(IntPtr window);
		...
		[DllImport(NCURSES_LIB)]
        internal static extern int mvgetch(int y, int x);

		[DllImport(NCURSES_LIB)]
        internal static extern int mvwgetch(IntPtr window, int y, int x);

		[DllImport(NCURSES_LIB)]
        internal static extern int addstr(string str);

		[DllImport(NCURSES_LIB)]
        internal static extern int waddstr(IntPtr window, string str);


        [DllImport(NCURSES_LIB)]
        internal static extern int mvaddstr(int y, int x, string str);

		[DllImport(NCURSES_LIB)]
        internal static extern int mvwaddstr(IntPtr window, int y, int x, string str);

        // doesn't work with UTF
        [DllImport(NCURSES_LIB)]
        internal static extern int mvaddch(int y, int x, char ch);

		[DllImport(NCURSES_LIB)]
        internal static extern int mvwaddch(IntPtr window, int y, int x, char ch);
		...
		[DllImport(NCURSES_LIB)]
        internal static extern int wattron(IntPtr window, int attrs);

        [DllImport(NCURSES_LIB)]
        internal static extern int attrset(int attrs);

		[DllImport(NCURSES_LIB)]
        internal static extern int wattrset(IntPtr window, int attrs);
		...
		[DllImport(NCURSES_LIB)]
        internal static extern int wattroff(IntPtr window, int attrs);
        ...
        [DllImport(NCURSES_LIB)]
        internal static extern int border(char ls, char rs, char ts, char bs, char tl, char tr, char bl, char br);

        [DllImport(NCURSES_LIB)]
        internal static extern int wborder(IntPtr window, char ls, char rs, char ts, char bs, char tl, char tr, char bl, char br);

        [DllImport(NCURSES_LIB)]
        internal static extern int hline(char ch, int n);

        [DllImport(NCURSES_LIB)]
        internal static extern int whline(char ch, int n);

        [DllImport(NCURSES_LIB)]
        internal static extern int vline(char ch, int n);

        [DllImport(NCURSES_LIB)]
        internal static extern int wvline(char ch, int n);

		#endregion

        #region Cursor and Size

        [DllImport(NCURSES_LIB)]
        internal static extern int getmaxx(IntPtr window);

        [DllImport(NCURSES_LIB)]
        internal static extern int getmaxy(IntPtr window);

        [DllImport(NCURSES_LIB)]
        internal static extern int getcurx(IntPtr window);

        [DllImport(NCURSES_LIB)]
        internal static extern int getcury(IntPtr window);
        #endregion
